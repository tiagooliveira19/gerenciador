<?php
    ...
    if ($id) {
        ...
        $select_usuarios = 'SELECT nome, idade, rua, bairro, estado, biografia, imagem, data_criacao FROM usuarios WHERE id = '. $id;
    ...
    <div class="col-md-12 mt-5">
        ...
        <div class="col-md-10 mx-auto">
            ...
            <form class="mt-3" autocomplete="off" method="post" action="/app/validacoes/edicao/editar_usuario.php">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <input type="text" class="form-control" name="rua" id="rua" placeholder="Rua" value="<?php echo $rua ?: ''; ?>" required>
                    </div>

                    <div class="col">
                        <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Bairro" value="<?php echo $bairro ?: ''; ?>" required>
                    </div>
                </div>

                <div class="row mt-2">
                    <div class="col-6">
                        <input type="text" class="form-control" name="estado" id="estado" placeholder="Estado" value="<?php echo $estado ?: ''; ?>" required>
                    </div>
                </div>
